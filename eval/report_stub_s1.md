...
n=300 · generator=0.2.0 · times_scored=19 · n_treated=227 · n_holdout=73

## Primary KPI — incremental ₹ recovered per 1,000 at-risk (vs. holdout)

- **Incremental: ₹4723392.62 per 1,000** (95% CI [2675865.42, 6606950.03], 2000 bootstrap resamples)
- Gross recovered ₹/case — treated: ₹5596.74, holdout: ₹873.35 (printed beside incremental deliberately — the gap is the argument, not the gross figure)
- Gross recovery rate — treated: 20.3%, holdout: 6.8%

## AI quality — diagnosis on the AMBIGUOUS subset only

- Ambiguous macro-F1: **0.331** (n=105). Overall accuracy across all cases is NOT reported — it is inflated by the CLEAN majority, which never reaches the model.
  - TRANSIENT_INFRA: P=0.00 R=0.00 F1=0.00 support=0
  - CUSTOMER_FIXABLE: P=0.62 R=0.45 F1=0.53 support=33
  - INSTRUMENT_INVALID: P=0.50 R=0.11 F1=0.17 support=19
  - TERMINAL: P=0.93 R=0.47 F1=0.62 support=53

## Secondary metrics

- Wasted-attempt rate: 13.5% (23/170 attempts landed on a case whose hidden true class is TERMINAL)
...
- Policy veto rate: **23.1%** (51/221 RETRY proposals denied) — target band [5%, 40%]: near 0 means the gate is decorative, near 100% means the model is useless
